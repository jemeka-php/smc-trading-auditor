...
SIGNAL_SYSTEM_INSTRUCTION = (
    ...
    "3. ENTRY ZONE: Define a precise entry price or zone (e.g. limit order range). "
    "Specify whether it is a MARKET entry (current price), LIMIT entry (wait for pull), "
    "or STOP entry (breakout trigger).\n\n"
    "4. STOP LOSS: Place SL at the structural invalidation level — beyond the swing that "
    "breaks the setup thesis. Must be specific and logical, not arbitrary.\n\n"
    "5. TAKE PROFIT TARGETS: Provide 3 graduated targets:\n"
    "   - TP1 (Conservative): First meaningful structure, 1:1 to 1.5:1 R:R — close 40% here.\n"
    ...
    "7. CONFLUENCE SCORE: Rate the setup confidence from 1-10 based on the number and quality "
    "of confluencing factors. Only recommend trades scoring 6/10 or higher.\n\n"
    "8. INVALIDATION CONDITIONS: State exactly what price action would invalidate this signal "
    "BEFORE entry (e.g. candle close above X level).\n\n"
    "9. TIMEFRAME CONTEXT: Identify the chart timeframe and note whether the signal is "
    "intraday (scalp/day trade) or positional (swing trade).\n\n"
...
SIGNAL_OUTPUT_TEMPLATE = (
    ...
    "| **Asset & TF** | [Symbol from chart — e.g. BTC/USDT · 4H] |\n"
    ...
    "| **Stop Loss** | [Exact price — e.g. 63,750] |\n"
    ...
    "| **Signal Type** | [Intraday / Swing / Positional] |\n\n"
    "---\n\n"
    "### 📌 Confluence Factors\n"
    ...
    "* [Condition 2]\n\n"
    "### 📋 Execution Notes\n"
    "[2-3 practical notes on how to execute: entry trigger, position sizing approach, "
